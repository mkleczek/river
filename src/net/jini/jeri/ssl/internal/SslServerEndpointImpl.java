...
import static net.jini.jeri.ssl.internal.Utilities.ANY_KEY_ALGORITHM;
import static net.jini.jeri.ssl.internal.Utilities.INTEGRITY_PREFERRED;
import static net.jini.jeri.ssl.internal.Utilities.INTEGRITY_REQUIRED;
import static net.jini.jeri.ssl.internal.Utilities.UNKNOWN_PRINCIPAL;
import static net.jini.jeri.ssl.internal.Utilities.getClassName;
import static net.jini.jeri.ssl.internal.Utilities.getClientPrincipals;
import static net.jini.jeri.ssl.internal.Utilities.getKeyAlgorithm;
import static net.jini.jeri.ssl.internal.Utilities.getServerSSLContextInfo;
import static net.jini.jeri.ssl.internal.Utilities.getSupportedCipherSuites;
import static net.jini.jeri.ssl.internal.Utilities.logThrow;
import static net.jini.jeri.ssl.internal.Utilities.safeEquals;
import static net.jini.jeri.ssl.internal.Utilities.serverLogger;
...
import net.jini.jeri.ssl.internal.Utilities.SSLContextInfo;
 ...
 * 
 */
public class SslServerEndpointImpl extends SslServerEndpoint {
     ...
     * anonymous.
     */
    public final Set serverPrincipals;
    ...
    public SslServerEndpointImpl(Subject serverSubject,
    ...
    public final InvocationConstraints checkConstraints(
    ...
    public final Endpoint enumerateListenEndpoints(ListenContext listenContext)
	throws IOException
    {
    ...
    public class SslListenEndpoint extends Utilities implements ListenEndpoint {
    ...
    public class SslListenHandle extends Utilities implements ListenHandle {
	...
	public SslListenHandle(RequestDispatcher requestDispatcher,
			ServerSocket serverSocket)
	    throws IOException
	{
    ...
    public final class SslListenCookie implements ListenCookie {
	...
	public final SSLSocket sslSocket;
	...
	protected SslServerConnection(SslListenHandle listenHandle, Socket socket)
	    throws IOException
	{
	 ...
	 */
	protected void closeInternal(boolean removeFromListener)
	    throws IOException
	{
	    synchronized (this) {
		if (closed) {
