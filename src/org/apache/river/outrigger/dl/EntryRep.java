 ...
 */
package org.apache.river.outrigger.dl;
...
public class EntryRep implements StorableResource<EntryRep>, LeasedResource, Serializable {
    ...
    private volatile ClassAnnotation	codebase;	// the codebase for this entry class
...
//		"associated with entry of type " + className, e);
	...
	expires      = in.readLong();
	codebase     = (ClassAnnotation)in.readObject();
