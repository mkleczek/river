 ...
 */
package org.apache.river.outrigger.start;
...
import org.apache.river.outrigger.OutriggerServerWrapper;
 ...
 * @since 2.0
 */
public class PersistentOutriggerImpl extends OutriggerServerWrapper {
    /**
     ...
     */
    public PersistentOutriggerImpl(ActivationID activationID, 
     ...
     *         an exception when login is attempted.
     */
    public PersistentOutriggerImpl(String[] configArgs, LifeCycle lifeCycle) 
        throws IOException, ConfigurationException, LoginException
    {
