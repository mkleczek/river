...
class ActivatableNormServerImpl extends NormServerBaseImpl
{
    ...
    public void destroy() throws RemoteException
    {
        ...
        {
            /*
             * Activation system is shutting down or this object has already been unregistered -- ignore in either case.
             */
    ...
    void postDestroy()
    {
        ...
        try
        {
            net.jini.activation.ActivationGroup.inactive(activationID, exporter);
    ...
    /**
     * Provides a constructor for an activatable implementation of NormServer suitable for use with
     * {@link ServiceStarter}.
     *
     * @param activationID
     *                     activation ID passed in by the activation daemon
     * @param data
    ...
    {
        /*
         * Any Exception thrown happens prior to super being called, so this isn't susceptible to finalizer attacks.
         */
    ...
    private static class Init extends NormServerInitializer
    {
        ...
        void initAsSubject(Configuration config) throws Exception
        {
            ...
            ProxyPreparer activationIdPreparer = (ProxyPreparer) Config.getNonNullEntry(config, NORM,
        ...
        {
            Exporter result = (Exporter) Config.getNonNullEntry(config, NORM, "serverExporter", Exporter.class,
