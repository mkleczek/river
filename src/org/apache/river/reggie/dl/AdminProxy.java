...
/**
 * Proxy for administering a registrar, returned from the getAdmin method of the main registrar proxy. Clients only see
 * instances via the DiscoveryAdmin, JoinAdmin, DestroyAdmin and ReferentUuid interfaces.
 *
 * @author Sun Microsystems, Inc.
 */
public class AdminProxy implements DiscoveryAdmin, JoinAdmin, DestroyAdmin, ReferentUuid, Serializable
{
    ...
    /**
     * Returns AdminProxy or ConstrainableAdminProxy instance, depending on whether given server implements
     * RemoteMethodControl.
     */
    public static AdminProxy getInstance(Registrar server,
                                         ServiceID registrarID)
    {
        return (server instanceof RemoteMethodControl) ? new ConstrainableAdminProxy(server, registrarID, null)
    ...
    {
        return getClass().getName() + "[registrar=" + registrarID + " " + server + "]";
    }
