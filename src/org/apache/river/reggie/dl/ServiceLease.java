...
/**
 * A ServiceLease is a proxy for a service registration lease at a registrar. Clients only see instances via the Lease
 * interface.
 *
...
public class ServiceLease extends RegistrarLease
{
    ...
    /**
     * Returns ServiceLease or ConstrainableServiceLease instance, depending on whether given server implements
     * RemoteMethodControl.
     */
                                           ...
                                           long expiration)
    {
        return (server instanceof RemoteMethodControl)
                ? new ConstrainableServiceLease(server, registrarID, serviceID, leaseID, expiration, null)
                : new ServiceLease(server, registrarID, serviceID, leaseID, expiration);
    }
