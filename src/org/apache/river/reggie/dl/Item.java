...
/**
 * An Item contains the fields of a ServiceItem packaged up for transmission between client-side proxies and the
...
public class Item implements Serializable, Cloneable
{
    ...
    static
    {
        ...
        {
            b = (Boolean) Security
                    .doPrivileged(new GetBooleanAction("org.apache.river.reggie.enableImplToStubReplacement"));
        }
    ...
    /**
     * Converts a ServiceItem to an Item. Any exception that results is bundled up into a MarshalException.
     */
    ...
    /**
     * Convert back to a ServiceItem. If the service object cannot be constructed, it is set to null. If an Entry cannot
     * be constructed, it is set to null. If a field of an Entry cannot be unmarshalled, it is set to null.
     */
    public ServiceItem get()
    {
        ...
        return new ServiceItem(serviceID, obj, EntryRep.toEntry(attributeSets));
    }
